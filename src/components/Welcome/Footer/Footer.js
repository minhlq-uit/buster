      ...
      <div className='footer-links'>
        ...
        <div className='heading'>
          ...
          <div className='social-networks'>
            <FacebookIcon style={{fontSize: 50, marginRight: 20 }} className='icon' />
            <InstagramIcon style={{fontSize: 50, marginRight: 20 }} className='icon' />
            <TwitterIcon style={{fontSize: 50, marginRight: 20 }} className='icon' />
            <LinkedInIcon style={{fontSize: 50, marginRight: 20 }} className='icon' />
          </div>
        </div>
